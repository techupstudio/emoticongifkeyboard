package com.techupstudio.emoticongifkeyboard.database;
...
public final class EmoticonDbHelper extends SQLiteAssetHelper {
     ...
     */
    public EmoticonDbHelper(@NonNull Context context) {
     ...
     */
    @NonNull
    public ArrayList<Emoticon> getEmoticons(@EmoticonsCategories.EmoticonsCategory final int category,
     ...
     */
    @NonNull
    public ArrayList<Emoticon> searchEmoticons(@NonNull final String searchQuery,
                                               @Nullable EmoticonProvider emoticonProvider) {
        SQLiteDatabase sqLiteDatabase = getReadableDatabase();
